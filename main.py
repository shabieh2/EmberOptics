...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='weights/best3.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default=str(Path(f'{get_detection_folder()}'),
    ...
    if source_index == 0:
        ...
        uploaded_file = st.sidebar.file_uploader("Videos", type=['mp4'])
        if uploaded_file is not None:
            is_valid = True
            with st.spinner(text='Detecting...'):
